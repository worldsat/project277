# ☕ Modern Coffee Shop App UI with Kotlin & XML
...
[![Watch the video](https://img.youtube.com/vi/9bwN5wQeHOs/maxresdefault.jpg)]()
...
* **`drawable` folders**: All the required assets ( images, Category icons, Backgrounds, etc.) organized for the project. You can download and add these directly to your `res` folder.
* **`layout` previews**: Images of the UI design to help you follow along.

---

## 💎 Get the Full Source Code

The **Complete Source Code** for this Online Shop App is available exclusively for channel members.
...
2.  Copy the contents of the `drawable` folder.
